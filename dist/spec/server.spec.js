...
describe('Server API Endpoints', () => {
    ...
    describe('GET /api/images', () => {
        it('should return list of images', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            spyOn(fs, 'readdir').and.returnValue(Promise.resolve(fakeFiles));
            const res = yield (0, supertest_1.default)(server_1.app).get('/api/images');
            expect(fs.readdir).toHaveBeenCalledWith(path_1.default.join(process.cwd(), 'images'), jasmine_1.default.anything());
            expect(res.status).toBe(200);
        ...
        it('should return 500 if reading directory fails', () => __awaiter(void 0, void 0, void 0, function* () {
            spyOn(fs, 'readdir').and.returnValue(Promise.reject(new Error('Failed to read')));
            const res = yield (0, supertest_1.default)(server_1.app).get('/api/images');
            expect(res.status).toBe(500);
